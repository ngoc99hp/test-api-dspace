...
import { Download, Clock, CheckCircle, XCircle, ChevronLeft, ChevronRight, Loader2 } from 'lucide-react';
...
export default function OCRJobsList({ 
  ...
  const isAllSelected = completedJobs.length > 0 && selectedJobs.length === completedJobs.length;
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            {isAnalyzing ? (
              ...
              <>
                🤖 Analyze {selectedJobs.length} Document{selectedJobs.length > 1 ? 's' : ''}
              </>
            )}
          </button>
        </div>
      ...
      {jobs.length === 0 ? (
        <div className="p-12 text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">Upload PDFs to get started</p>
        </div>
      ) : (
        <>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <TooltipFilename filename={job.filename} jobId={job.job_id} />
                      </td>
          ...
          {totalPages > 1 && (
            <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
              <div className="text-sm text-gray-600">
                ...
                <span className="font-semibold">{Math.min(endIndex, jobs.length)}</span> of{' '}
